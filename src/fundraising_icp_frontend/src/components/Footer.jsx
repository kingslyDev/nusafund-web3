        ...
        <div className="container px-5 py-16 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          ...
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-300">
              <img src={logo} alt="Nusantara Logo" className="w-40 h-auto object-contain animate-glow" />
              <span className="ml-3 text-2xl font-bold text-white"></span>
            </a>
            <p className="mt-4 text-sm text-gray-400">Spread Without Limits Across the Nusantara</p>
          </div>
        ...
        <div className="bg-gray-800">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-400 text-sm text-center sm:text-left">
              © 2024 NusaFund —
              <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-400 hover:text-white ml-1" target="_blank">
                @CrowdFunding
              </a>
            </p>
